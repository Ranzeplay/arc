using Arc.Compiler.PackageGenerator.Ginkgo.Encoders;
...
public class ArcScopeTreeGroupNode : ArcScopeTreeNodeBase, IArcEncodableGinkgoScopeTreeNode
{
    ...
    [
        ...
        ..ArcGinkgoGroupSymbolEncoder.EncodeGroupSymbol(this)
    ];
