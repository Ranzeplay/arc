...
internal static class ArcGinkgoScopeTreeHelpers
{
    public static ICollection<ArcScopeTreeNodeBase> FlattenNodes(this ArcScopeTreeNodeBase node)
    {
        ...
        {
            nodes.AddRange(child.FlattenNodes());
        }
    ...
    private static ArcScopeTreeNamespaceNode MergeNamespaceNodes(ArcScopeTreeNamespaceNode ns1, ArcScopeTreeNamespaceNode ns2, bool overwrite = false)
    {
