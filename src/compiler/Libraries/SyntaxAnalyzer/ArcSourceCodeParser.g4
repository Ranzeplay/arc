...
arc_instant_value: NUMBER | LITERAL_STRING | arc_bool_value | KW_NONE;
arc_type_value: KW_TYPEOF LPAREN arc_expression RPAREN;
arc_data_value: arc_instant_value | arc_function_call_base | arc_flexible_identifier | arc_type_value;
...
// TODO: incremental
arc_stmt_assign: arc_flexible_identifier ASSIGN arc_expression;
