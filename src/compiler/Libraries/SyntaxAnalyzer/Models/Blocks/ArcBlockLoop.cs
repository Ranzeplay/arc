...
{
    internal class ArcBlockLoop(ArcSourceCodeParser.Arc_stmt_loopContext context) : ArcExecutionStepBase, IArcTraceable<ArcSourceCodeParser.Arc_stmt_loopContext>
    {
