...
{
    public class ArcBlockConditionalLoop(ArcSourceCodeParser.Arc_stmt_whileContext context) : ArcExecutionStepBase, IArcTraceable<ArcSourceCodeParser.Arc_stmt_whileContext>
    {
