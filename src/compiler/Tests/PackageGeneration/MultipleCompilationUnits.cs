...
namespace Arc.Compiler.Tests.PackageGeneration
{
    ...
    internal class MultipleCompilationUnits
    {
        ...
        {
            var compilationUnitContext1 = AntlrAdapter.ParseCompilationUnit(Text1, _logger);
            var compilationUnitContext2 = AntlrAdapter.ParseCompilationUnit(Text2, _logger);
