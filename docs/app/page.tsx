import { Activity, Book, Code, Power, Scale, Users } from "lucide-react";
...
export default function Home() {
  return (
    <main className={`flex flex-1 flex-col my-8 lg:justify-center container px-4 md:px-6 lg:px-8 h-full mx-auto ${bodyFont.className}`}>
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-x-4">
        <Link href="/usage" className="btn btn-primary flex flex-row gap-x-2 items-center justify-center">
          <Power size={20} />
